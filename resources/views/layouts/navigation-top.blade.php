        ...
        @if (Route::has('login'))
            ...
            <div>
                <ul class="flex gap-4 md:gap-8">
                    @auth
                        <li>
                            <x-nav-link :href="route('member_area')" :active="request()->routeIs('member_area')" class="group font-black">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="member-area-icon group-hover:fill-white">
                        ...
                        <li>
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-nav-link :href="route('logout')" class="group font-black">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="member-area-icon group-hover:fill-white">
